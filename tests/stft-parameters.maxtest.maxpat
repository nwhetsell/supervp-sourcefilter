...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 300.0, 225.0, 33.0, 22.0 ],
					"text" : "== 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 131.0, 225.0, 33.0, 22.0 ],
					"text" : "== 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 285.0, 165.0, 22.0 ],
					"text" : "test.assert changed-hop-ratio"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 300.0, 255.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 131.0, 180.0, 58.0, 22.0 ],
					"text" : "jit.cycle 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 131.0, 285.0, 146.0, 22.0 ],
					"text" : "test.assert initial-hop-ratio"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"parameter_mappable" : 0,
					"patching_rect" : [ 131.0, 255.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 255.0, 375.0, 33.0, 22.0 ],
					"text" : "== 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 73.0, 375.0, 33.0, 22.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 435.0, 183.0, 22.0 ],
					"text" : "test.assert changed-interpolation"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"parameter_mappable" : 0,
					"patching_rect" : [ 255.0, 405.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 73.0, 330.0, 58.0, 22.0 ],
					"text" : "jit.cycle 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.0, 435.0, 164.0, 22.0 ],
					"text" : "test.assert initial-interpolation"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"parameter_mappable" : 0,
					"patching_rect" : [ 73.0, 405.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 195.0, 525.0, 53.0, 22.0 ],
					"text" : "== 2048"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 585.0, 183.0, 22.0 ],
					"text" : "test.assert changed-window-size"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "route windowsize fftover oversamp"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "test.assert initial-window-size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.0, 60.0, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "stft-parameters.js",
						"parameter_enable" : 0
					}
,
					"text" : "js stft-parameters.js"
				}
